...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (count($errors)) {
        ...
        if (count($errors)) {
            ...
            $writer = new Writer;
            $writer->update($item['id'], $name, $job_title, $about, $image_path);
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="job_title" class="form-control" id="job_title" value="<?= $item['job_title'] ?>" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img style="width:160px; height: 200px;" class="img-thumbnail" src="<?= url($item['image']) ?>" alt="">
