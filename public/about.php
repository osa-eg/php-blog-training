                    ...
                    <div class="timeline">
                        <div class="timeline-item" data-aos="fade-up" data-aos-delay="0">
                            <div class="timeline-content">
                                ...
                                <p>ModernBlog was founded by three friends who shared a passion for quality content and beautiful design.</p>
                            </div>
                        </div>
                        <div class="timeline-item" data-aos="fade-up" data-aos-delay="100">
                            <div class="timeline-content">
                                <h5>2021 - First 10K Readers</h5>
                                <p>We reached our first major milestone with 10,000 monthly readers and launched our newsletter.</p>
                            </div>
                        </div>
                        <div class="timeline-item" data-aos="fade-up" data-aos-delay="200">
                            <div class="timeline-content">
                                <h5>2022 - Team Expansion</h5>
                                <p>We welcomed new writers and designers to our team, allowing us to cover more topics and publish more frequently.</p>
                            </div>
                        </div>
                        <div class="timeline-item" data-aos="fade-up" data-aos-delay="300">
                            <div class="timeline-content">
                                <h5>2023 - Global Recognition</h5>
                                <p>Our articles started being featured by major publications, and we crossed 50,000 monthly readers.</p>
                            </div>
                        </div>
                        <div class="timeline-item" data-aos="fade-up" data-aos-delay="400">
                            <div class="timeline-content">
                                <h5>2024 - Innovation Continues</h5>
                                <p>We're constantly evolving, introducing new formats and exploring emerging topics to serve our growing community better.</p>
                            </div>
                        </div>
                    </div>
                </div>
